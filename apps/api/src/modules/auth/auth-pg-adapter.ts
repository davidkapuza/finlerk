...
import { Account } from '@finlerk/shared';
import type { Pool } from 'pg';

export function mapExpiresAt(account: Account): AdapterAccount {
...
export default function AuthPgAdapter(client: Pool): Adapter {
  return {
